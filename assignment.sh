...
if [ -d assignment ]; then
  echo "Recreating the assignment directory"
  rm -rf assignment
fi
mkdir assignment
cd assignment
...
ls data/processed/server_logs -1 >> data/inventory.txt
ls data/processed/user_logs -1 >> data/inventory.txt
ls data/processed/event_logs -1 >> data/inventory.txt
